...
class NotificadorPartidos {
  ...
  iniciar() {
    ...
    this.verificarPartidos(); // Verificación inmediata
    this.intervalo = setInterval(() => this.verificarPartidos(), this.intervaloVerificacion);
  }
  ...
  // Verificar si hay partidos próximos
  verificarPartidos() {
    ...
    this.partidos.forEach(partido => {
      ...
      // Mostrar notificación: 30 min antes Y hasta 2.5 horas después
      ...
      } else if (this.notificacionesActivas.has(partido.id)) {
        // Cerrar notificación si está fuera del rango
        this.cerrarNotificacion(partido.id);
      }
    });
  }
